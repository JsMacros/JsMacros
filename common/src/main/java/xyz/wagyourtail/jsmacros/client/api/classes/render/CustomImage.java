...
public class CustomImage {
    ...
    /**
     * Tries to create a new font from the given path and size. Only TTF fonts are supported.
     *
     * @param path     the path to the font file, relative to the config folder
    ...
    /**
     * Tries to create a new font from the given path. Only TTF fonts are supported.
     *
     * @param path the path to the font file, relative to the config folder
     * @return self for chaining.
     *
