...
public class Draw2D extends DrawableHelper implements IDraw2D<Draw2D> {
    ...
    public TextElement addText(String text, int x, int y, int color, int zIndex, boolean shadow, double scale, double rotation) {
        return reAddElement(new TextElement(text, x, y, color, zIndex, shadow, scale, (float) rotation));
    }
    ...
    /**
     * @since 1.0.5
     * @see IDraw2D#removeText(TextElement)
     */
    @Override
    public Draw2D removeText(TextElement t) {
        synchronized (elements) {
            elements.remove(t);
        }
        return this;
     ...
     */
    @Override
    public ImageElement addImage(int x, int y, int width, int height, String id, int imageX, int imageY, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
     ...
     */
    @Override
    public ImageElement addImage(int x, int y, int width, int height, String id, int imageX, int imageY, int regionWidth, int regionHeight, int textureWidth, int textureHeight, double rotation) {
    ...
    public ImageElement addImage(int x, int y, int width, int height, int zIndex, int color, String id, int imageX, int imageY, int regionWidth, int regionHeight, int textureWidth, int textureHeight, double rotation) {
        return reAddElement(new ImageElement(x, y, width, height, zIndex, color, id, imageX, imageY, regionWidth, regionHeight, textureWidth, textureHeight, (float) rotation));
    }
    /**
     * @since 1.6.5
    ...
    public ImageElement addImage(int x, int y, int width, int height, int zIndex, int alpha, int color, String id, int imageX, int imageY, int regionWidth, int regionHeight, int textureWidth, int textureHeight, double rotation) {
        return reAddElement(new ImageElement(x, y, width, height, zIndex, alpha, color, id, imageX, imageY, regionWidth, regionHeight, textureWidth, textureHeight, (float) rotation));
    }

    /**
     * @since 1.2.3
     * @see IDraw2D#removeImage(ImageElement)
     */
    @Override
    public Draw2D removeImage(ImageElement i) {
        synchronized (elements) {
            elements.remove(i);
        }
        return this;
    ...
    public RectElement addRect(int x1, int y1, int x2, int y2, int color) {
        return reAddElement(new RectElement(x1, y1, x2, y2, color, 0F, 0));
    }
    ...
    public RectElement addRect(int x1, int y1, int x2, int y2, int color, int alpha, double rotation, int zIndex) {
        return reAddElement(new RectElement(x1, y1, x2, y2, color, alpha, (float) rotation, zIndex));
    }
    
    /**
     * @since 1.0.5
     * @see IDraw2D#removeRect(RectElement)
     */
    @Override
    public Draw2D removeRect(RectElement r) {
        synchronized (elements) {
            elements.remove(r);
        }
        return this;
    ...
    @Override
    public Draw2D removeLine(LineElement l) {
        synchronized (elements) {
            elements.remove(l);
        }
        return this;
    ...
    public ItemElement addItem(int x, int y, int zIndex, String id, boolean overlay, double scale, double rotation) {
        return reAddElement(new ItemElement(x, y, zIndex, id, overlay, scale, (float) rotation));
    }
    ...
    public ItemElement addItem(int x, int y, int zIndex, ItemStackHelper item, boolean overlay, double scale, double rotation) {
        return reAddElement(new ItemElement(x, y, zIndex, item, overlay, scale, (float) rotation));
    }
    
    /**
     * @since 1.0.5
     * @see IDraw2D#removeItem(ItemElement)
     */
    @Override
    public Draw2D removeItem(ItemElement i) {
        synchronized (elements) {
            elements.remove(i);
        }
        return this;
