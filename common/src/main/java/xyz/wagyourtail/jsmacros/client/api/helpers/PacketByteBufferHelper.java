...
public class PacketByteBufferHelper extends BaseHelper<PacketByteBuf> {
    ...
    public PacketByteBufferHelper writeIdentifier(String id) {
        base.writeIdentifier(new Identifier(id));
        return this;
    }
    ...
    public Map<String, Object> readBlockHitResultMap() {
        ...
        return Map.of("side", new DirectionHelper(hitResult.getSide()), "blockPos", new BlockPosHelper(hitResult.getBlockPos()), "missed", ((IBlockHitResult) hitResult).jsmacros_missed(), "inside", hitResult.isInsideBlock());
    }
     ...
     * @since 1.8.4
     */
    public PacketByteBufferHelper writeFloat(float value) {
     ...
     * @since 1.8.4
     */
    public PacketByteBufferHelper setFloat(int index, float value) {
        base.setFloat(index, value);
        return this;
    }
