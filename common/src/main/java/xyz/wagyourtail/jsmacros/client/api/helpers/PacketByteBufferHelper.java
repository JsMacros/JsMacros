...
public class PacketByteBufferHelper extends BaseHelper<PacketByteBuf> {
    ...
    public PacketByteBufferHelper sendCustomPacket(String channel) {
        MinecraftClient.getInstance().getNetworkHandler().sendPacket(new CustomPayloadC2SPacket(new Identifier(channel), base));
        return this;
    }
    ...
    public static void init() {
        ...
        PACKETS.put("ChatPreviewS2CPacket", net.minecraft.network.packet.s2c.play.ChatPreviewS2CPacket.class);
        ...
        PACKETS.put("PlaySoundIdS2CPacket", net.minecraft.network.packet.s2c.play.PlaySoundIdS2CPacket.class);
        PACKETS.put("HideMessageS2CPacket", net.minecraft.network.packet.s2c.play.HideMessageS2CPacket.class);
        ...
        PACKETS.put("ResourcePackSendS2CPacket", net.minecraft.network.packet.s2c.play.ResourcePackSendS2CPacket.class);
        ...
        PACKETS.put("MessageHeaderS2CPacket", net.minecraft.network.packet.s2c.play.MessageHeaderS2CPacket.class);
        ...
        PACKETS.put("ChatPreviewStateChangeS2CPacket", net.minecraft.network.packet.s2c.play.ChatPreviewStateChangeS2CPacket.class);
        ...
        PACKETS.put("SynchronizeTagsS2CPacket", net.minecraft.network.packet.s2c.play.SynchronizeTagsS2CPacket.class);
        ...
        PACKETS.put("RequestChatPreviewC2SPacket", net.minecraft.network.packet.c2s.play.RequestChatPreviewC2SPacket.class);
        ...
        PACKETS.put("CustomPayloadC2SPacket", net.minecraft.network.packet.c2s.play.CustomPayloadC2SPacket.class);
        ...
        PACKETS.put("ResourcePackStatusC2SPacket", net.minecraft.network.packet.c2s.play.ResourcePackStatusC2SPacket.class);
        ...
        PACKETS.put("QueryPongS2CPacket", net.minecraft.network.packet.s2c.query.QueryPongS2CPacket.class);
