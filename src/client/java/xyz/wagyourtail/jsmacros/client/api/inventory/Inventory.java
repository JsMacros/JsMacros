...
import xyz.wagyourtail.jsmacros.client.access.access.IHorseScreen;
import xyz.wagyourtail.jsmacros.client.access.access.IInventory;
...
public class Inventory<T extends ScreenHandler> {
    ...
    public static Inventory<?> create() {
        ...
        if (inv == null) {
            ...
            return new xyz.wagyourtail.jsmacros.client.api.inventory.PlayerInventory(new InventoryScreen(mc.player));
        }
        return inv;
    }
    ...
    public static Inventory<?> create(@Nullable Screen s) {
        if (s instanceof HandledScreen) {
            if (s instanceof MerchantScreen) {
                ...
                return new xyz.wagyourtail.jsmacros.client.api.inventory.PlayerInventory((InventoryScreen) s);
