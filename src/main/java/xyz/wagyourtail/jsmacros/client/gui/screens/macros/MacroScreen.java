...
import xyz.wagyourtail.jsmacros.client.gui.elements.containers.MacroContainer;
import xyz.wagyourtail.jsmacros.client.gui.elements.containers.MacroListTopbar;
import xyz.wagyourtail.jsmacros.client.gui.elements.overlays.AboutOverlay;
import xyz.wagyourtail.jsmacros.client.gui.elements.overlays.ConfirmOverlay;
import xyz.wagyourtail.jsmacros.client.gui.elements.overlays.EventChooser;
...
public class MacroScreen extends BaseScreen {
    ...
    protected void init() {
        ...
        topbar = new MacroListTopbar(this, this.width / 12, 25, this.width * 5 / 6, 14, this.textRenderer, ScriptTrigger.TriggerType.KEY_RISING, this::addButton, this::addMacro, this::runFile);
    ...
    public void runFile() {
        openOverlay(new FileChooser(width / 4, height / 4, width / 2, height / 2, this.textRenderer, Core.instance.config.macroFolder, null, this::addButton, this::removeButton, this::closeOverlay, this::setFocused, (file) -> {
            try {
