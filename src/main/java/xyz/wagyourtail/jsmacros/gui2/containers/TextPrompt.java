...
public class TextPrompt extends OverlayContainer {
    ...
    public TextPrompt(int x, int y, int width, int height, TextRenderer textRenderer, StringRenderable message, String defaultText, Consumer<AbstractButtonWidget> addButton, Consumer<AbstractButtonWidget> removeButton, Consumer<OverlayContainer> close, Consumer<Element> setFocused, Consumer<String> accept) {
