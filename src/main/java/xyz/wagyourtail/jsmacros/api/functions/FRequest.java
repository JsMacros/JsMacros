 ...
 *
 */
public class FRequest extends Functions {
    
    public FRequest(String libName) {
        super(libName);
    }
    
    public FRequest(String libName, List<String> excludeLanguages) {
     ...
     * @since 1.1.8
     * 
     * @see xyz.wagyourtail.jsmacros.api.classes.HTTPRequest
     * 
     * @param url
     ...
     * @since 1.1.8
     * 
     * @see xyz.wagyourtail.jsmacros.api.classes.HTTPRequest.Response
     * 
     * @param url
     * @param headers
     ...
     * @since 1.2.7
     * 
     * @see xyz.wagyourtail.jsmacros.api.classes.Websocket
     * 
     * @param url
     * @return
     * @throws IOException
